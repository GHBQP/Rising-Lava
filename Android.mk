...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -isystem 'extern' -I'extern/codegen/include' -DID='"risinglava"' -DVERSION='"0.1.0"' -I'./shared' -I'./extern' -Wno-inaccessible-base
